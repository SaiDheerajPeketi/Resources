...
export function AiLesson({ topicId }: { topicId: string }) {
  ...
  return <CurriculumLesson topicId={topicId} lesson={lesson} reviewNote="Reviewed 19 September 2026. Re-check current research, model, and provider documentation before production decisions." />;
}
