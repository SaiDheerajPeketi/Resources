...
export function AiLesson({ topicId }: { topicId: string }) {
  ...
  return <CurriculumLesson lesson={lesson} reviewNote="Reviewed 18 September 2026. Re-check current research, model, and provider documentation before production decisions." />;
}
