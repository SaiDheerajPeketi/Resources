...
export function SecurityLesson({ topicId }: { topicId: string }) {
  ...
  return <CurriculumLesson lesson={lesson} reviewNote="Reviewed 19 September 2026. Educational material only; re-check current standards, threats, and jurisdictional requirements." />;
}
