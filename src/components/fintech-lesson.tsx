...
export function FintechLesson({ topicId }: { topicId: string }) {
  ...
  return <CurriculumLesson lesson={lesson} reviewNote="Reviewed 19 September 2026. Educational material only—not legal, investment, trading, or financial advice. Verify current rules and product requirements." />;
}
