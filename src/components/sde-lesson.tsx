...
export function SdeLesson({ topicId }: { topicId: string }) {
  ...
  return <CurriculumLesson topicId={topicId} lesson={lesson} reviewNote="Reviewed 19 September 2026. Verify implementation-specific behavior against the current standard and official documentation." />;
}
